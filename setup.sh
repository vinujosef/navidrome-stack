...
link_script "$SCRIPT_DIR/audio-cover-art-fix.sh" "audio-cover-art-fix"
link_script "$SCRIPT_DIR/audio-metadata-normalize.sh" "audio-metadata-normalize"
...
echo "- audio-cover-art-fix"
echo "- audio-metadata-normalize"
